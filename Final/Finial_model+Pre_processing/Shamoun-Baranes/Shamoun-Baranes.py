...
# animal_BirdID_317_pre_data

a = animal_BirdID_317_pre_data.resample('D').mean()
animal_BirdID_317_data = a.resample('D').interpolate('linear')

# animal_BirdID_317_data

###############################################################################################
pre_days =10
animal_BirdID_317_data['label_1'] = animal_BirdID_317_data['Longitude'].shift(-pre_days)
animal_BirdID_317_data['label_2'] = animal_BirdID_317_data['Latitude'].shift(-pre_days)

# Standardlise
from sklearn.preprocessing import StandardScaler
scalar = StandardScaler()
data_scalar = scalar.fit_transform(animal_BirdID_317_data.iloc[:,:-2])
# print(data_scalar)
...
queue_output = animal_BirdID_317_data.iloc[:,2:4].values[memory_days-1:-pre_days]
# print(queue_output)
...
# plot
import matplotlib.pyplot as plt
data_time = animal_BirdID_317_data.index[-len(queue_output_test):]
...
joblib.dump(animal_BirdID_317_data, dirs+'/results_data.txt')
